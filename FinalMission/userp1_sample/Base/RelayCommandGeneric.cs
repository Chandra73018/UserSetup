...
namespace userp1_sample.Base
{
    class RelayCommandGeneric
    {
        public RelayCommandGeneric(Action selExecute, Func<bool> canExecute)
        {
            SelExecute = selExecute;
            CanExecute = canExecute;
        }

        public Action SelExecute { get; private set; }
